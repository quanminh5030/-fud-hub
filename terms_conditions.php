    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <p>These terms and conditions outline the rules and regulations for the use of FUD-HUB's Website,
                    located at fudhub.com.</p>
                ...
                <p>We employ the use of cookies. By accessing FUD-HUB, you agreed to use cookies in agreement with the
                    FUD-HUB's Privacy Policy.</p>
                ...
                <p>Unless otherwise stated, FUD-HUB and/or its licensors own the intellectual property rights for all
                    material on FUD-HUB. All intellectual property rights are reserved. You may access this from FUD-HUB
                    for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from FUD-HUB</li>
                    <li>Sell, rent or sub-license material from FUD-HUB</li>
                    <li>Reproduce, duplicate or copy material from FUD-HUB</li>
                    <li>Redistribute content from FUD-HUB</li>
                </ul>

                <p>This Agreement shall begin on the date hereof.</p>

                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. FUD-HUB does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of FUD-HUB,its agents
                    and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, FUD-HUB shall not be liable for the Comments
                ...
                <p>FUD-HUB reserves the right to monitor all Comments and to remove any Comments which can be considered
                ...
                <p>You hereby grant FUD-HUB a non-exclusive license to use, reproduce, edit and authorize others to use,
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make
                    ...
                    the absence of FUD-HUB; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to FUD-HUB. Please include your name, your
                ...
                <p>No use of FUD-HUB's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
